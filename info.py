...
API_ID = int(environ.get('API_ID', '20803355'))
API_HASH = environ.get('API_HASH', 'caa85d91bcde4e8826ad697de02af771')
BOT_TOKEN = environ.get('BOT_TOKEN', "8548428672:AAEb7nf8hgBPLu17hme69lO_jXxr3JT_D9E")

CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/vTelegraphBot-08-29-30')).split() 
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6964203412 8023726997').split()] 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002086319581').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002573823548'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002551533001'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-100'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002648671971')) 
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://yuvijangra:yuvijangra@cluster0.zhv5sqg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://uvjangra:uvjangra@cluster0.cmjdvgq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/movie_backup_group")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/movie_backup_group")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/movie_backup_group")
